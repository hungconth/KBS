...
export default function Block({ title, onDelete, index, onReset }: BlockProps) {


    return (
        <>
            <div id="readProductModal"   className=" overflow-y-auto overflow-x-hidden top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                <div className="relative p-4 flex  h-full md:h-auto">
                   
                    <div className="relative p-4 bg-white rounded-lg shadow  sm:p-5 flex flex-col justify-center">
                     
                        <div className="flex justify-between mb-4 rounded-t sm:mb-5">
                            <div className="text-lg text-gray-900 md:text-xl dark:text-black">
                        ...
                        <button type="button" onClick={()=>{onDelete(index); onReset('')}}
